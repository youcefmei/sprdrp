...
//        try {
//            pharmacy.addDoctorGeneral(new DoctorGeneral(null,"firstnamedoctora","lastnamedoctora","0202020202",
//                    "maildoctora@free.fr","45 rue de la liberté","Nancy","54020",
//                    "1520364879")
//            );
//            pharmacy.addDoctorGeneral(new DoctorGeneral(null,"firstnamedoctorb","lastnamedoctorb","0304060809",
...
//        try {
//            pharmacy.addDoctorSpecialized(new DoctorSpecialized(null,"firstnamedoctorspea","lastnamedoctorspea",
//                    "0202020202","maildoctorspea@free.fr","45 rue de la liberté","Nancy",
//                    "54020","1524364879","Neurologie")
//            );
//            pharmacy.addDoctorSpecialized(new DoctorSpecialized(null,"firstnamedoctorspeb","lastnamedoctorspb",
...
//        try {
//            pharmacy.addPatient(new Patient(null,"firstnamepatienta","lastnamepatienta","0101010101",
...
//            );
//
//            pharmacy.addPatient(new Patient(null,"firstnamepatientb","lastnamepatientb","0202020202",
...
//        try {
//            State state = new State(1,"Paris","75");
//            pharmacy.addHealthMutual(new HealthMutual("Acoris Mutuelles","0606060606","heathmutual1@gmail.com","10 rue blabla","75000","Paris",state,80));
//            pharmacy.addHealthMutual(new HealthMutual("ADREA Mutuelle","0606060606","heathmutual2@gmail.com","12 rue blabla","75000","Paris",state,60));
//            pharmacy.addHealthMutual(new HealthMutual("APREVA","0606060606","heathmutual3@gmail.com","12 rue blabla","75000","Paris",state,100));
//            pharmacy.addHealthMutual(new HealthMutual("Avenir Mutuelle","0606060606","heathmutual4@gmail.com","12 rue blabla","75000","Paris",state,53));
//            pharmacy.addHealthMutual(new HealthMutual("Avenir Santé Mutuelle","0606060606","heathmutual5@gmail.com","12 rue blabla","75000","Paris",state,25));
//            pharmacy.addHealthMutual(new HealthMutual("CCMO","0606060606","heathmutual6@gmail.com","12 rue blabla","75000","Paris",state,33));
//            pharmacy.addHealthMutual(new HealthMutual("France Mutuelle","0606060606","heathmutual7@gmail.com","12 rue blabla","75000","Paris",state,66));
//            pharmacy.addHealthMutual(new HealthMutual("GFP","0606060606","heathmutual8@gmail.com","12 rue blabla","75000","Paris",state,44));
//            pharmacy.addHealthMutual(new HealthMutual("Harmonie Mutuelle","0606060606","heathmutual9@gmail.com","12 rue blabla","75000","Paris",state,70));
